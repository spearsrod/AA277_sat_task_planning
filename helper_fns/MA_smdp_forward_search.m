function policies = MA_smdp_forward_search(s_0, d_solve, params)
    n_sats = size(s_0, 2);
    ...
    for idx = 1:n_sats
        ...
        cur_policy = single_smdp_forward_search(cur_s0, d_solve, cur_params);
        policies{idx} = cur_policy;
    end
    while(true)
        %TODO how to avoid comms already done?
        ...
        future_pol = single_smdp_forward_search(new_s, d_solve, cur_params);
