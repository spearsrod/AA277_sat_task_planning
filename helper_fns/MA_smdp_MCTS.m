function policies = MA_smdp_MCTS(s_0, d_solve, params)
    n_sats = size(s_0, 2);
    ...
    for idx = 1:n_sats
        ...
        cur_policy = single_smdp_MCTS(cur_s0, d_solve, cur_params);
    ...
    while(true)
        ...
        future_pol = single_smdp_MCTS(new_s, d_solve, cur_params);
